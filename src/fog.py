...
class FogColour:
    def __init__(self):
        ...
        self.factor = (1 / self.time_period) * 20
    ...
    def get_atten(self):
        ...
        # Night
        if 0 <= self.time < self.time_period:
        ...
        elif self.time_period <= self.time < self.time_period*2:
        ...
        # Day
        elif self.time_period*2 <= self.time < self.time_period*3:
